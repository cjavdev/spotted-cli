...
func handleMeEpisodesList(ctx context.Context, cmd *cli.Command) error {
	...
	if format == "raw" {
		...
		return ShowJSON(os.Stdout, os.Stderr, "me:episodes list", obj, format, explicitFormat, transform)
	} else {
		...
		return ShowJSONIterator(os.Stdout, os.Stderr, "me:episodes list", iter, format, explicitFormat, transform, maxItems)
	}
}
...
func handleMeEpisodesCheck(ctx context.Context, cmd *cli.Command) error {
	...
	explicitFormat := cmd.Root().IsSet("format")
	transform := cmd.Root().String("transform")
	return ShowJSON(os.Stdout, os.Stderr, "me:episodes check", obj, format, explicitFormat, transform)
}
