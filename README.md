...
You can link the CLI against a different version of the Spotted Go SDK
...
```bash
./scripts/link ../path/to/spotted-go
```

If you run the link script without any arguments, it will default to `../spotted-go`.
